...
def _train_crf(trainSetX, trainSetY, testSetX, testSetY):
    modelLogger = SaveLogger('save/cells-hog_viper.model', save_every=1)
...
def trainCRF():
    ...
    train_X, train_Y = preproc_data(basedir='dcore/train/x/',
                                    labeldir='dcore/train/y/')
    print 'Generating test set'
    test_X, test_Y = preproc_data(basedir='dcore/test/x/', labeldir='dcore/test/y/')
